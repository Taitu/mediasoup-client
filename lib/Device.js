...
function detectDevice() {
	...
	let isIOSWebKit;
        ...
        if (browser.parsedResult && browser.parsedResult.os && browser.parsedResult.os.name && browser.parsedResult.os.version) {
            isIOSWebKit = browser.parsedResult.os.name.toLocaleLowerCase() === "ios" && +browser.parsedResult.os.version >= 14;
        }
        ...
        else if ((browser.satisfies({ safari: '>=12.0' }) || browser.satisfies({ ios: '>=12.0' })) &&
